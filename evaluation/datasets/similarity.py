...
from evaluation.preprocess import preprocess_word
...
def fetch_WS353(which="all"):
    ...
    #                       'similarity', header=None, sep="\t")
        ...
        data = pd.read_csv('corpus/wordsim/set1.csv', header=0, sep=",")

        # data = _get_as_pd('https://www.dropbox.com/s/opj6uxzh5ov8gha/EN-WS353-SET1.txt?dl=1',
        #                   'similarity', header=0, sep="\t")
    elif which == "set2":
        data = pd.read_csv('corpus/wordsim/set2.csv', header=0, sep=",")
